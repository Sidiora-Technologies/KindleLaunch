...
const NormalButton = ({
    ...
    shadow,
    onClick
}: { content?: string; border?: string; borderRound?: string; background?: string; fontSize?: string; fontColor?: string; padding?: string; prefixIcon?: any; latterIcon?: any; size?: string; imageSize?: string; hover?: string; shadow?: string; onClick?: () => void }) => {
  return (
