...
import InputComponent from "@/ui/atoms/InputComponent";
    ...
    <Dropdown buttonContent={
        ...
        <li className="flex justify-between items-center text-size-10 text-dark-gray10">
          <div className="flex justify-start items-center gap-2">
            ...
            <div className="flex flex-col justify-start gap-1">
              <span className="text-size-12 text-red-yellow2">Sidiora Main</span>
        ...
        <li className="flex justify-between items-center text-size-10 text-dark-gray10">
          <div className="flex justify-start items-center gap-2">
            <InputComponent/>
            <div className="flex flex-col justify-start gap-1">
              <span className="text-size-12 text-pink-middle">Sidiora Main</span>
              <div className="flex items-center justify-start gap-3">
                <div className="flex items-center gap-1">
                    <Image src={plainImg} alt="plain" />
                    <span >Off</span>
