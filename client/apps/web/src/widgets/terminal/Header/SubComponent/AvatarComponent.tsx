      ...
      <div>
        <Dropdown buttonContent={
            ...
            <li className="flex justify-start items-center space-x-1 
                ...
                onClick={() => {
                  const modal = document.getElementById('my_modal_1') as HTMLElement | null;
                  if (modal) {
            ...
            <div className=" text-dark-disabled text-size-12">
              <div className="flex justify-between items-center border-b-1 border-dark-gray px-2 py-1 lg:px-5 lg:py-2">
                ...
                <div className="flex items-center justify-between gap-4">
                    <NormalButton latterIcon={linkblueImg} border="border-none" content="Set Referral Link" onClick={() => {
                      const modal = document.getElementById('my_refferal_modal') as HTMLElement | null;
                      if (modal) {
                        (modal as any).showModal();
                      }
                    }} />
