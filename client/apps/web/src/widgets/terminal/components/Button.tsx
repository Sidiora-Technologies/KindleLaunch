...
const Button = ({
    ...
    custom,
    paddingCustom,
}: { content?: string; icon?: any; btnEnabled?: boolean; border?: string; alert?: boolean; other?: string; textColor?: string; clickState?: boolean; fontSize?: string; backgroundColor?: string; custom?: string; paddingCustom?: string }) => {
